...
var ImageView = module.exports = BaseView.extend({
	...
	initialize: function initialize(options) {
		...
		this.className = _.result(this.options, 'className') || '';
		this.className = ' ' + _.result(this.options, 'position') || '';
		...
		if (ctx.workers.imageLoader && this.options.src && this.options.worker) {
			// Web Worker
