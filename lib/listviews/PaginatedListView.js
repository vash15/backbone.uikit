...
var PaginatedListView = module.exports = FilteredListView.extend({
	...
	initialize: function initialize(options) {
		this.events = {
			'click .list-load-more a': 'loadMore'
		};
	...
	render: function render() {
		...
		this.cache.$loadMore        = this.$el.find('.list-load-more');
		this.cache.$loadMoreTrigger = this.$el.find('.list-load-more a');
		this.cache.$loading         = this.$el.find('.list-load-more .list-loader');
