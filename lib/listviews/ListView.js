...
export default class ListView extends BaseView {
	...
	binarySearch(rows, x, y) {
		...
		const headerDeltaX = this.options.orientation === ORIENTATION_HORIZONTAL ? this.headerSize - this.options.headerSize : 0;
		const headerDeltaY = this.options.orientation === ORIENTATION_VERTICAL   ? this.headerSize - this.options.headerSize : 0;
