...
var template           = _.template(fs.readFileSync(__dirname+'/../../templates/listviews/list_view.html', 'utf8'));
...
var ListView = module.exports = BaseView.extend({
	...
	className: function className() {
		return 'list ' + ( _.result(this, "addClass") || '' );
	},
	...
	addItem: function addItem(model, options) {
		...
		var indexOfPreviusItem = indexOfModel - 1;
		var indexOfNextItem    = indexOfModel + 1;
		var previousItem       = indexOfPreviusItem > -1 ? collection.at( indexOfPreviusItem ) : null;
		var nextItem           = collection.at( indexOfNextItem );
