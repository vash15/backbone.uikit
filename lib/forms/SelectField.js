...
export default class SelectField extends BaseView {
	...
	constructor(options) {
		...
		this.options = {
			...
			label:		   typeof options.label         !== 'undefined' ? options.label         : null,
			invalid: 	   typeof options.invalid       !== 'undifined'	? options.invalid       : false
		};
	...
	onRender(rendered) {
		...
		if (this.options.invalid)
			this.$el.append($('<div>').addClass('ui-input-invalid').attr('data-invalid-field', this.fieldAttributes['field']));
